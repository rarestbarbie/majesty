...
extension PopSnapshot {
    ...
    func tooltipPortfolio(in cache: borrowing GameUI.Cache, id: CountryID) -> Tooltip? {
        ...
        return .instructions {
            ...
            $0[>] = """
            The wealth generated by overseas investments counts toward the GDP of the country
            the asset is located in, and the GNP of the country the investor resides in
            """
        }
    }
