...
extension GameDate.Year {
    @inlinable public var predecessor:Self { self.advanced(by: -1) }
    @inlinable public var successor:Self { self.advanced(by: 1) }
}
extension GameDate.Year: CustomStringConvertible {
    @inlinable public var description: String { "\(self.rawValue)" }
}
extension GameDate.Year: LosslessStringConvertible {
...
extension GameDate.Year {
    @inlinable public var vibe: (start: GameDate.Weekday, leap: Bool) {
        ...
        let base: GameDate.Weekday = leap ? .saturday : .sunday
